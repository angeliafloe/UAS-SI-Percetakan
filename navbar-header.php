                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Steven send you a message</h6>
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Angel send you a message</h6>
                                        <small>15 minutes ago</small>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="img/testimonial-1.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Nabiel send you a message</h6>
                                        <small>15 minutes ago</small>
                                    </div>
                                </div>
                            </a>
